...
type EnhancedGame struct {
	...
	PriceINR           float64     `json:"price_inr,omitempty" example:"1499.99"`
	OriginalINR        int         `json:"original_inr,omitempty" example:"2999"`
	DiscountPercent    int         `json:"discount_percent,omitempty" example:"50"`
}
...
type TrendingDeal struct {
	...
	CreatedAt      time.Time    `json:"created_at" example:"2026-01-01T00:00:00Z"`
	UpdatedAt      time.Time    `json:"updated_at" example:"2026-01-01T00:00:00Z"`
	Game           EnhancedGame `json:"game,omitempty"`
}
...
// Price Drop Notification model
type PriceDropNotification struct {
	AlertID      int64   `json:"alert_id" example:"1"`
	UserID       int64   `json:"user_id" example:"1"`
	GameID       int64   `json:"game_id" example:"1"`
	TargetPrice  float64 `json:"target_price" example:"999.00"`
	CurrentPrice float64 `json:"current_price" example:"799.00"`
	StoreID      int64   `json:"store_id" example:"1"`
	Discount     int     `json:"discount" example:"20"`
}

// Deal Alert model for price drop notifications
type DealAlert struct {
	ID               int64      `json:"id" example:"1"`
	UserID           int64      `json:"user_id" example:"1"`
	GameID           int64      `json:"game_id" example:"1"`
	TargetPrice      float64    `json:"target_price" example:"999.00"`
	StoreID          *int64     `json:"store_id,omitempty" example:"1"`
	Region           string     `json:"region" example:"IN"`
	Currency         string     `json:"currency" example:"INR"`
	IsActive         bool       `json:"is_active" example:"true"`
