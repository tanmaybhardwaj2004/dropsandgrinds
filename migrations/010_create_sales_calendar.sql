...
CREATE INDEX idx_sales_calendar_dates ON sales_calendar(start_date, end_date);

-- Index for platform filtering
CREATE INDEX idx_sales_calendar_platform ON sales_calendar(platform);

-- Index for recurring sales
CREATE INDEX idx_sales_calendar_recurring ON sales_calendar(is_recurring);

-- Insert known Steam sale patterns for 2026
INSERT INTO sales_calendar (name, platform, start_date, end_date, is_recurring) VALUES
